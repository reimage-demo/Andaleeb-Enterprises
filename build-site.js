...
<section class="ownership-block">
  ...
  <div class="ownership-copy focus-copy">
    <p>Andaleeb Enterprises is a real estate holding company. It primarily grows the value of the properties it owns by renovating buildings that have fallen into disrepair, upgrading their systems and storefronts, and filling long-standing vacancies with tenants who serve the neighborhoods around them.</p>
    <p>Rather than holding buildings at a distance, Andaleeb stays involved after acquisition: repairing what's broken, modernizing what's outdated, and working directly with tenants to keep space occupied. The result is a portfolio of properties that function well for the people who live and work in them, and for the lenders and municipalities that rely on them.</p>
  </div>
</section>
${homeStats}
